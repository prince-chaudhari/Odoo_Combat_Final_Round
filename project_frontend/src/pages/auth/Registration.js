  ...
  return <>
    <Box component='form' noValidate sx={{ mt: 1 }} id='registration-form' onSubmit={handleSubmit}>
      ...
      <StyledFormControl variant="outlined" fullWidth>
        <InputLabel id="first-field-label">Role</InputLabel>
        <Select
          labelId="first-field-label"
          value={firstField}
      ...
      {server_error.role ? <span style={{ fontSize: 12, color: 'red', paddingLeft: 10 }}>{server_error.role[0]}</span> : ""}
