...
import { AppBar, Toolbar, Typography, IconButton, Grid, TextField, InputAdornment, Box, Avatar, Button, Badge } from '@mui/material';
      ...
      <AppBar position="static" sx={{ backgroundColor: '#6B4D65' }}>
        <Toolbar>
          ...
          >
            ...
            <Button sx={{ marginLeft: "20px", fontFamily: "SK Curiosity", fontWeight: "400", fontSize: "70%", textTransform: "initial" }} color="inherit" onClick={() => setView('allBooks')}>All Books</Button>
            <Button sx={{ marginLeft: "20px", fontFamily: "SK Curiosity", fontWeight: "400", fontSize: "70%", textTransform: "initial" }} color="inherit" onClick={() => setView('myBooks')}>My Books</Button>
          </Typography>

          <div style={{ flexGrow: 1 }}></div>
          <IconButton color="inherit">
            <Badge variant='dot' sx={{ color: 'gold', fontSize: '20px', marginRight: '5px' }} color='error'>
        ...
        <Grid item xs={12} sm={8}>
          ...
          <div style={{ maxHeight: '70vh', overflowY: 'auto', scrollbarWidth: 'thin', scrollbarColor: '#976F8F #f1f1f1' }}>
            <Grid container spacing={0.4}>
              {filterBooks(view === 'allBooks' ? books : userBooks).map(book => (
        ...
        <Grid item xs={12} sm={4}>
          ...
          >
            ...
            >
              ...
              <Button sx={{
                marginLeft: "20px", fontFamily: "SK Curiosity", fontWeight: "400", fontSize: "110%", textTransform: "initial", backgroundColor: "#6B4D65"
                , color: "white", '&:hover': { color: "#6B4D65", backgroundColor: "#DCDCDC" }
              }} onClick={handleLogout}>          &nbsp;  <LogoutIcon />&nbsp;Logout &nbsp; </Button>
            </Box>
          </Box>
        </Grid>
      </Grid>
